          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                <h1 className="h1">Have a question about Certwise? Contact us directly</h1>
              </div>
              ...
              <form className="max-w-xl mx-auto">
                ...
                <div className="text-sm text-gray-600 mt-4">
                  By clicking "Send" you consent to allow Certwise to store and process the personal information submitted above and agree to our <a className="underline" href="/terms">terms and conditions</a> as well as our <a className="underline" href="/privacy">privacy policy</a>.
                </div>
              </form>
