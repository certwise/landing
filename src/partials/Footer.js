...
import logo from "../images/certwise_logo.png"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="mb-2">
              ...
              <Link to="/" className="inline-block" aria-label="Cruip">
                <img src={logo} alt="Certwise" className="h-12 w-auto rounded-full" />
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="/" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Platform</Link>
              </li>
              <li className="mb-2">
                <Link to="/roadmap" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Roadmap</Link>
              </li>
              <li className="mb-2">
                <Link to="/support" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Contact</Link>
              </li>
              {/* <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Forever Promise</Link>
              </li> */}
              {/* <li className="mb-2">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              <li className="mb-2">
                <Link to="/docs" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Documentation</Link>
              </li>
              <li className="mb-2">
                <Link to="/faq" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">FAQs</Link>
              </li>
              {/* <li className="mb-2">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <p className="text-sm text-gray-600 mb-4">Get notified about new product updates in your inbox!</p>
            <form>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <a href="https://twitter.com/CertwiseHQ" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter" target="_blank" rel="noreferrer">
            ...
            <li className="ml-4">
              <a href="https://github.com/certwise" className="flex justify-center items-center text-gray-600 hover:text-gray-900 bg-white hover:bg-white-100 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github" target="_blank" rel="noreferrer">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; 2021 Certwise. All rights reserved.
          </div>
