            ...
            <table className="table-auto w-full border-b border-gray-200">
              ...
              <thead>
                <tr className="text-base sm:text-lg border-t border-gray-200">
                  ...
                  <th className="text-bold text-center px-2 py-4">Trial</th>
              ...
              <tbody>
                ...
                <tr className="border-t border-gray-200">
                  <td className="text-sm sm:text-base pr-2 py-4">
                    <div className="font-medium underline">Templates</div>
                ...
                <tr className="border-t border-gray-200">
                  <td className="text-sm sm:text-base pr-2 py-4">
                    <div className="font-medium underline">Recipients</div>
                ...
                <tr className="border-t border-gray-200">
                  <td className="text-sm sm:text-base pr-2 py-4">
                    <div className="font-medium underline">Credentials</div>
